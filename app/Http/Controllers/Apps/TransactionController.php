...
class TransactionController extends Controller
{
    ...
    public function increment(Request $request)
    {
        ...
        if ($cart && $request->qty < $stock) {
            ...
            return redirect()->route('apps.transactions.index')->with('error', 'Stok Tidak Cukup!.');
        }
    }
    ...
    public function decrement(Request $request)
    {
        ...
        if ($cart) {
            ...
            return redirect()->route('apps.transactions.index')->with('error', 'Keranjang Tidak ditemukan');
        }
    }

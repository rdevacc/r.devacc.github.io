<template>
    ...
    <Head>
        <title>Reset Password | Koperasi BBP Mektan</title>
    </Head>
    <div class="col-md-4">
        <div class="fade-in">
            <div class="text-center mb-4">
                <a href="" class="text-dark text-decoration-none">
                    ...
                    <h3 class="mt-2 font-weight-bold">APLIKASI KOPERASI BBP MEKTAN</h3>
                </a>
            </div>
                        ...
                        <form @submit.prevent="submit">
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control" v-model="form.email" :class="{ 'is-invalid': errors.email }"
                                    type="email" placeholder="Email Address" disabled>
                            </div>
